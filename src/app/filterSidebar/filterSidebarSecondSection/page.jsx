...
import FilterSidebarThirdSection from '../filterSidebarThirdSection/page';

const Page = ({ resetFilter, isActive, toggleSidebar }) => {
  const categories = ['210', '220', '230', '240', '250', '260', '270', '280', '290', '300'];
    ...
    <div>
      <div className={styles.filterContent}>
          ...
          <div className="section_top">
              <p style={{marginLeft:'-23px'}}>사이즈</p>
            </div>
          </div>
        </div>
        <div className="filter_section">
          <div className="section_top">
            <p style={{marginLeft:'10px'}}>신발</p>
        ...
        <FilterSidebarThirdSection resetFilter={resetFilter}/>
    </div>
  );
}
